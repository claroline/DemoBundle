...
$maintenanceMode = file_exists(__DIR__ . '/../app/config/.refresh_demo');
        ...
        <div class="col-md-offset-4 col-md-4">
            <div class="panel panel-default">
                ...
                <div class="panel-body text-center">
                    <p>Veuillez patienter pendant la réinitialisation de la pateforme.</p>
                    <p>Please wait while the platform is being reinitialized.</p>
